...
describe('JSONTool', () => {
  ...
  describe('JSON Formatting', () => {
    ...
    it('should show error for invalid JSON', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/syntax error/i) || screen.getByText(/invalid json/i) || screen.getByText(/error/i)).toBeInTheDocument()
      })
    })
  ...
  describe('JSON Validation', () => {
    it('should validate correct JSON', async () => {
      ...
      const inputTextarea = getTextarea(container)
      const validateButton = getButton(container, 'Validate')
      ...
      await waitFor(() => {
        expect(screen.getByText(/valid json/i) || screen.getByText(/✓/)).toBeInTheDocument()
      })
    })
